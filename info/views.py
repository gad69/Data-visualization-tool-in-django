...
def marks_list(request, stud_id):
    ...
    for ass in ass_list:
        try:
            ...
            sc.save()
            sc.marks_set.create(type='I', name='Quiz1')
            print(sc)
            sc.marks_set.create(type='I', name='Quiz2')
            print(sc)
            sc.marks_set.create(type='I', name='Quiz3')
            print(sc)
            sc.marks_set.create(type='E', name='Minor1')
            sc.marks_set.create(type='E', name='Minor2')
...
# teacher marks
@login_required()
def barks_list(request, stud_id):
    stud = Student.objects.get(USN=stud_id, )
    ass_list = Assign.objects.filter(class_id_id=stud.class_id)
    sc_list = []
    for ass in ass_list:
    ...
    return render(request, 'info/base.html', {'sc_list': sc_list})
