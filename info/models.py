...
class Marks(models.Model):
    ...
    name = models.CharField(max_length=50, choices=test_name, default='Quiz1')
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.save()
                    sc.marks_set.create(name='Quiz1')
                    sc.marks_set.create(name='Quiz2')
                    sc.marks_set.create(name='Quiz3')
                    sc.marks_set.create(name='Minor1')
                    sc.marks_set.create(name='Minor2')
